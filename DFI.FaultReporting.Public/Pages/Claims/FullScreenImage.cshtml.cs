...
namespace DFI.FaultReporting.Public.Pages.Claims
{
    public class FullScreenImageModel : PageModel
    {
        ...
        public FullScreenImageModel(ILogger<FullScreenImageModel> logger, IUserService userService, IClaimService claimService,
        ...
        public async Task<IActionResult> OnGetAsync(int? ID)
        {
            ...
            if (_httpContextAccessor.HttpContext.User != null)
            {
                ...
                if (_httpContextAccessor.HttpContext.User.Identity.IsAuthenticated == true && HttpContext.User.IsInRole("User"))
                {
