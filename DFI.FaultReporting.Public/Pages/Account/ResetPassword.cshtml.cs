...
namespace DFI.FaultReporting.Public.Pages.Account
{
    public class ResetPasswordModel : PageModel
    {
        ...
        public ResetPasswordModel(IUserService userService, IUserRoleService userRoleService, IRoleService roleService, ILogger<ResetPasswordModel> logger, IHttpContextAccessor httpContextAccessor,
        ...
        public async Task<IActionResult> OnPostRequestVerificationCode()
        {
            ...
            {
                EmailExists = await _userService.CheckEmail(loginInput.Email);
        ...
        public async Task<IActionResult> OnPostResetPassword()
        {
            ...
            if (isPasswordInputValid)
            {
                ...
                if (Verified == true)
                {
                    ...
                    bool PasswordReset = await _userService.ResetPassword(email, password);
