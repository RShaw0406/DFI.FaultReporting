...
namespace DFI.FaultReporting.Models.Admin
{
    public class RepairStatus
    {
        ...
        [Required(ErrorMessage = "You must enter a repair status description")]
        [StringLength(50, ErrorMessage = "Repair status description must not be more than 50 characters")]
